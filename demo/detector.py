...
def main(args):
    ...
    # model.test_cfg['rcnn']['score_thr'] = 0
    # model.test_cfg['rcnn']['max_per_img'] = 10000
    result = inference_detector(model, args.image)
    # show the results
    
    show_result_pyplot(model, args.image, result, score_thr=args.score_thr, out_file='test.png')
