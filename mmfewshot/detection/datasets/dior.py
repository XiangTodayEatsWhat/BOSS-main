...
DIOR_SPLIT = dict(
    ALL_CLASSES_SPLIT1=('airport', 'basketballcourt', 'bridge', 'chimney', 'dam', 
    ...
    ALL_CLASSES_SPLIT2=('airport', 'dam', 'Expressway-Service-area', 'Expressway-toll-station', 'golffield', 
                        'groundtrackfield', 'harbor','overpass', 'stadium', 'storagetank',
                        'vehicle', 'airplane', 'tenniscourt', 'trainstation', 'windmill',
                        'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship'),
    
    ALL_CLASSES_SPLIT3=('basketballcourt', 'bridge', 'chimney', 'dam', 'Expressway-Service-area',
                        'golffield', 'overpass', 'ship', 'stadium', 'storagetank', 
                        'vehicle',  'baseballfield', 'tenniscourt', 'trainstation', 'windmill',
                        'airplane', 'airport', 'Expressway-toll-station', 'harbor', 'groundtrackfield'),
    
    ALL_CLASSES_SPLIT4=('airport', 'Expressway-Service-area', 'Expressway-toll-station', 'groundtrackfield', 'harbor',
                        'overpass', 'stadium', 'airplane',  'trainstation', 'windmill',
                        'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship',
                        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle'),
    
    ALL_CLASSES_SPLIT5=('airport', 'Expressway-toll-station', 'groundtrackfield', 'harbor', 'airplane',  
                        'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship',
                        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle',
                        'Expressway-Service-area', 'overpass', 'stadium', 'trainstation', 'windmill'),
    
    NOVEL_CLASSES_SPLIT1=('airplane','baseballfield', 'tenniscourt', 'trainstation', 'windmill'),
    
    NOVEL_CLASSES_SPLIT2=('baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship'),
    
    NOVEL_CLASSES_SPLIT3=('airplane', 'airport', 'Expressway-toll-station', 'harbor', 'groundtrackfield'),
    
    NOVEL_CLASSES_SPLIT4=('dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle'),
    
    NOVEL_CLASSES_SPLIT5=('Expressway-Service-area', 'overpass', 'stadium', 'trainstation', 'windmill'),
    
    BASE_CLASSES_SPLIT1=('airport', 'basketballcourt', 'bridge', 'chimney', 
    ...
    BASE_CLASSES_SPLIT2=('airport', 'dam', 'Expressway-Service-area', 'Expressway-toll-station', 'golffield', 
                        'groundtrackfield', 'harbor','overpass', 'stadium', 'storagetank',
                        'vehicle', 'airplane', 'tenniscourt', 'trainstation', 'windmill'),
    
    BASE_CLASSES_SPLIT3=('basketballcourt', 'bridge', 'chimney', 'dam', 'Expressway-Service-area',
                        'golffield', 'overpass', 'ship', 'stadium', 'storagetank', 
                        'vehicle',  'baseballfield', 'tenniscourt', 'trainstation', 'windmill'),
    
    BASE_CLASSES_SPLIT4=('airport', 'Expressway-Service-area', 'Expressway-toll-station', 'groundtrackfield', 'harbor',
                        'overpass', 'stadium', 'airplane',  'trainstation', 'windmill',
                        'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship'),
    
    BASE_CLASSES_SPLIT5=('airport', 'Expressway-toll-station', 'groundtrackfield', 'harbor', 'airplane',  
                        'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'ship',
                        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle')
    )
...
class FewShotDIORDataset(BaseFewShotDataset):
    ...
    def load_annotations_xml(
        ...
        for img_name in img_names:
            ...
            xml_path = osp.join(self.img_prefix, 'Annotations', 'Horizontal Bounding Boxes',
                                f'{img_id}.xml')
            ...
            ann_info = self._get_xml_ann_info(img_id, classes)
            data_infos.append(
                dict(
                    id=img_id,
                    filename=filename,
    ...
    def _get_xml_ann_info(self,
        ...
        Args:
            dataset_year (str): Year of DIOR dataset. 
    ...
    def evaluate(self,
        ...
        """Evaluation in DIOR protocol and summary results of different splits
        of classes.
