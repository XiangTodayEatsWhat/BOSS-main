...
NWPU_SPLIT = dict(
    ALL_CLASSES_SPLIT1=('bridge', 'harbor', 'ground track field', 'ship', 'storage tank', 
...
class FewShotNWPUDataset(BaseFewShotDataset):
    ...
    def _get_xml_ann_info(self,
        ...
        Args:
            dataset_year (str): Year of NWPU dataset.
    ...
    def evaluate(self,
        ...
        """Evaluation in NWPU protocol and summary results of different splits
        of classes.
        ...
        Args:
            ...
            class_splits: (list[str] | None): Calculate metric of classes
                split  defined in NWPU_SPLIT. For example:
...
class FewShotNWPUDefaultDataset(FewShotNWPUDataset):
    ...
    nwpu_benchmark = {
        f'SPLIT{split}_{shot}SHOT': [
            dict(
                type='ann_file',
                ann_file=f'../data/few_shot_ann/NWPU/benchmark_{shot}shot/'
    ...
    DEFAULT_ANN_CONFIG = dict(
        ...
        TFA=nwpu_benchmark,
        FSCE=nwpu_benchmark,
        Attention_RPN=nwpu_benchmark,
        MPSR=nwpu_benchmark,
        MetaRCNN=nwpu_benchmark,
        FSDetView=nwpu_benchmark)
